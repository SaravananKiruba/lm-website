...
import { Box, VStack, Heading, Text, HStack, Icon, Link, Button } from '@chakra-ui/react';
    ...
    <Box>
      <VStack spacing={6} align="stretch">
        ...
        <VStack align="start" spacing={4}>
          <HStack spacing={3}>
            <Icon as={FaMapMarkerAlt} color="brand.primary" boxSize={5} />
            <Text>{CONTACT_INFO.address}</Text>
          </HStack>
          
          <HStack spacing={3}>
            <Icon as={FaPhone} color="brand.primary" boxSize={5} />
          ...
          <HStack spacing={3}>
            <Icon as={FaMobile} color="brand.primary" boxSize={5} />
          ...
          <HStack spacing={3}>
            <Icon as={FaWhatsapp} color="brand.primary" boxSize={5} />
          ...
          <HStack spacing={3} align="flex-start">
            <Icon as={FaClock} color="brand.primary" boxSize={5} mt={1} />
            <VStack align="start" spacing={1}>
